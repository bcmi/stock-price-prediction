...
# model.add(Dropout(0.4))
model.add(Dense(1))
# r = RMSprop(lr=0.003, rho=0.9, epsilon=1e-06, decay=0.9995)
# a = Adam(lr=0.003, beta_1=0.9, beta_2=0.999, decay=0.9996)
...
#     model.reset_states()
model.fit(X_train, Y_train, epochs=2, batch_size=64, validation_data=(X_val, Y_val), callbacks=[callback], shuffle=True)
